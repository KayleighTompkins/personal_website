...
-   Traditionally humans have found knowledge through books, journals and websites. An important source of knowledge sharing has also been through peer to peer exchange and teaching.

-   Discovered vs found/production vs collection

-   Find knowledge through experience, social process
...
-   Knowledge - structured and applied information, based on true information, can use it to solve a problem.

List of AI discrepencies:

-   I've noticed a number of hallucinations across all AI agents that I've used, including making up academic papers.

-   I've also submitted the same command asking an LLM to do the same tast the same way and have received different outputs as the conversion progression - I think this is an example of context rot - attention to detail degrades as the conversation grows longer.

-   I've also noticed that LLMs can latch on to one part of a prompt rather strictly, rather than balancing out its output across the prompts.

-   Pro models are better than normal - sometimes dramatically so.

-   The size and complexity of a prompt is really important in determining output.

## Reflection 5

Prediction vs explanation: when does it matter why something happens and when is it enough to know what will happen?

Causal diagram for a relationship in my research area, confounders. Distinguish a causal claim from a predictive associaiton.

## Assignment 3

[Download my Machine Learning Lab](Lab_ML01.R)

## Reflection 6

How can text mining reveal patters that close reading alone cannot? What are its blind spots? How can NLP and LLM assist in my research and provide data/assistance for my project? Name limitations and suggest solutions? Write an AI research guide incorporated ethical, technical and academic concerns that could lead to more problems than solutions (e.g. Hinton)

## Assignment 4 

[Download my WordFish Lab](Assignment4.pdf)